...
return Object.defineProperty(i,"__esModule",{value:!0}),i}catch(n){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("web-miniproject/app").default.create({name:"web-miniproject",version:"0.0.0+35650e96"})
